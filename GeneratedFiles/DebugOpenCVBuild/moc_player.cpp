...
QT_MOC_LITERAL(4, 24, 12), // "processFrame"
QT_MOC_LITERAL(5, 37, 6) // "toggle"

    },
    "Player\0sendFrame\0\0image\0processFrame\0"
    "toggle"
};
...
void Player::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Player::sendFrame)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Player::sendFrame(const QImage & _t1)
{
